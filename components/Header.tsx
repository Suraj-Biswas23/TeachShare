      ...
      <div className="container mx-auto px-6 py-4">
        <div className="flex justify-between items-center">
          <Link href="/" className="flex items-center">
            {/* <Image src="/logo.png" alt="TeachShare Logo" width={40} height={40} /> */}
          ...
          <nav className="hidden md:flex items-center space-x-6">
            ...
            <Link href="/sign-up" className="bg-blue-600 text-white px-6 py-2 rounded-full hover:bg-blue-700 transition duration-300">Sign Up</Link>
          </nav>
        </div>
